              ...
              <div class="card-body">
                ...
                >
                  ...
                  <div class="" data-validate="Name is required">
                    <label style="color: #333">Nama Kegiatan:</label>
                    <br />
                    <input
                      class="form-control"
                      type="text"
                  ...
                  >
                    <label style="color: #333">Deskripsi Kegiatan:</label>
                    <br />
                    <textarea
                      style="height: 150px"
                      class="form-control"
                      ...
                      required
                    >
<?php echo $row['desc_kegiatan'];?></textarea
                    >
                    <span class="shadow-input1"></span>
                    <br />
                  </div>
                  <div
                    ...
                    data-validate="Name is required"
                  >
                    <label style="color: #333">Tanggal Kegiatan:</label>
                    <br />
                    <input
                      class="form-control"
                      type="date"
                      name="tgl_kegiatan"
                      placeholder=""
                      value="<?php echo $row['tgl_kegiatan'];?>"
                      required
                    />
                    <span class="shadow-input1"></span>
                    <br />
                  ...
                  <div class="wrap-input1 validate-input">
                    <label style="color: #333">Foto Kegiatan:</label>
                    <br />
                    <input
                      name="foto"
                      class="form-control"
                      type="file"
                      value="<?php echo $row['foto_kegiatan'];?>"
                      id="formFile"
                      accept=".jpg,.jpeg,.png"
                      required
                    />
                ...
                <a href="dashboard.php"
                  ><button class="btn btn-danger mt-4">Kembali</button></a
                >
              </div>
            </div>
          </div>
